...
type InscriptionOperation string

const (
	InscriptionOperationTransfer InscriptionOperation = "transfer"
)

// AllValues returns all InscriptionOperation values.
func (InscriptionOperation) AllValues() []InscriptionOperation {
	return []InscriptionOperation{
		InscriptionOperationTransfer,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s InscriptionOperation) MarshalText() ([]byte, error) {
	switch s {
	case InscriptionOperationTransfer:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *InscriptionOperation) UnmarshalText(data []byte) error {
	switch InscriptionOperation(data) {
	case InscriptionOperationTransfer:
		*s = InscriptionOperationTransfer
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
